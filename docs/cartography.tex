...
MDS clusters captured more of the known clades, but they also collected all clades descended from A1 into the same cluster and suffered from more unassigned samples than the other embeddings.
