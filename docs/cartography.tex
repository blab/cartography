...
\jhc{Maybe this is a good place to reference a supplemental cluster-specific mutation table.}
...
\centering
\caption*{
  {\bf S1 Table. Average Euclidean distances between each known recombinant, ``X'', and its parental lineages ``A'' and ``B'' per embedding method.}
...
Ability to capture reassortment events
Ability to reflect intermediate state of recombinant lineages
t-SNE best for clusters (tendency to produce more clusters)
MDS best for meaningful embedding distances
