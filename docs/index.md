...
<br>
<p> A tree build was run using nextstrain-cli for influenza H3N2 to obtain metadata and genomic data. An aligned FASTA file was created in the results folder of a tree build from fauna (https://github.com/nextstrain/fauna/tree/master/builds)
This data is available at<a href="https://github.com/blab/cartography/tree/master/notebooks/Data">here</a> for free use
</p>
<p> 
<br>
