...
\caption{{\bf Number of clusters (\emph{n\_clusters}) identified by HDBSCAN, transitions between clusters in the phylogeny, and excess transitions indicating non-monophyletic groups per pathogen dataset and embedding method.}
  ...
  Data available at \url{https://zenodo.org/records/13381647/files/S2_Table.csv}.}\label{S_Table_monophyletic_clusters}
\end{table}
...
Data available at \url{https://zenodo.org/records/13381647/files/S3_Table.csv}.}\label{S_Table_mutations_per_cluster}
\end{table}
...
Data available at \url{https://zenodo.org/records/13381647/files/S4_Table.csv}.}\label{S_Table_recombinant_distances}
\end{table}
...
Data available at \url{https://zenodo.org/records/13381647/files/S5_Table.tsv}.}\label{S_Table_accessions}
\end{table}
