...
Within the 1,992 sequences from 21J (Delta), we found 37 Pango lineages after collapsing lineages with fewer than 10 sequences into their parent lineages.
We found 44 t-SNE clusters representing 1,466 sequences with 526 sequences (26\%) assigned to the unclustered ``-1'' label.
The VI distance between all clusters (including the ``-1'' group) and the Pango lineages was 0.16.
This distance was consistent with the distance of 0.14 between t-SNE clusters and Pango lineages from both the full early and late SARS-CoV-2 datasets.
The VI distance between clusters without the -1 group and Pango lineages was 0.07, confirming that half of the distance between t-SNE clusters and Pango lineages above came from unclustered sequences.
Of the 35 Pango lineages with a t-SNE cluster, 21 lineages (60\%) had a single corresponding t-SNE cluster and 12 lineages (34\%) had 2 or 3 t-SNE clusters.
The remaining two lineages, AY.4 and B.1.617.2, had 5 and 10 t-SNE clusters, respectively.
Of the 44 t-SNE clusters, 29 clusters (66\%) had a single corresponding Pango lineage, 14 (32\%) mapped to two Pango lineages, and one cluster (43) mapped to 6 Pango lineages.
