...
However, we found that the optimal thresholds were the same for both lineage definitions (Supplementary Table~S\ref{S_Table_optimal_cluster_parameters}).
...
Clusters from all methods were generally supported by cluster-specific mutations including 2 of 3 PCA clusters (67\%), 9 of 16 MDS clusters (56\%), 15 of 19 t-SNE clusters (79\%) and 5 of 6 UMAP clusters (83\%) (Supplementary Table~S\ref{S_Table_mutations_per_cluster}).
The 19 clusters from t-SNE were closest to the 24 Nextstrain clades (normalized VI=0.09) followed by MDS, UMAP, and PCA with distances of 0.15, 0.16, and 0.23, respectively (Fig.~\ref{fig:sars-cov-2-2020-2022-clusters-vs-Nextstrain-clade})
...
The 19 clusters from t-SNE were the closest (normalized VI=0.14) followed by MDS, UMAP, and PCA with distances of 0.23, 0.25, and 0.32, respectively.
...
Only t-SNE and UMAP clusters were fully monophyletic (Supplementary Table~S\ref{S_Table_monophyletic_clusters}).
PCA and t-SNE clusters were best supported by cluster-specific mutations with 6 of 7 clusters (86\%) and 51 of 66 clusters (77\%), respectively (Supplementary Table~S\ref{S_Table_mutations_per_cluster}).
...
Compared to the 18 Nextstrain clades defined in this time period, the closest clusters were from t-SNE (normalized VI=0.09) and UMAP (normalized VI=0.09, Fig.~\ref{fig:sars-cov-2-2022-2023-clusters-vs-Nextstrain-clade}).
However, t-SNE produced 66 clusters, more than five times UMAP's 13.
...
We observed similar absolute and relative distances to Nextstrain clades across methods at different sampling densities under an even geographic and temporal sampling scheme (Supplementary Fig.~S\ref{S_Fig_late_sarscov2_replication_of_cluster_accuracy}A).
In the presence of geographic and genetic bias associated with randomly sampling the late SARS-CoV-2 data, UMAP produced the most accurate clusters across all sampling densities (Supplementary Fig.~S\ref{S_Fig_late_sarscov2_replication_of_cluster_accuracy}B).
