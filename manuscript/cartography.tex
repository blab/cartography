...
Cluster accuracies for most methods remained robust to sampling bias and density (\nameref{S_Fig_late_flu_replication_of_cluster_accuracy}).
...
Specifically, we sampled 500, 1000, 1500, or 2000 total sequences for five replicates per pathogen (random seeds of 0, 1, 2, 3, and 4) with either even sampling by geography and time or random sampling.
