...
if __name__ == "__main__":
    ...
    parser.add_argument("--table", nargs="+", help="table to make node data from")
    ...
    if args.output is not None:
        embedding_dict = pd.DataFrame(args.table,sep=args.separator, index_col=0).transpose().to_dict()
